...
private:
  ...
  RC create_plan(UnionStmt *union_stmt, unique_ptr<LogicalOperator> &logical_operator);
  ...
  RC create_order_by_plan(SelectStmt *select_stmt, unique_ptr<LogicalOperator> &logical_operator, int limit = -1);
